...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        f"👉 [Click Here to Join](https://t.me/+2h6IjvBZXRg0YmI1)\n"
        "After joining the channel, click 'I Have Joined' to proceed."
    )
    
    keyboard = [
        [InlineKeyboardButton("📢 Join Channel", url=f"https://t.me/+2h6IjvBZXRg0YmI1")],
...
async def genkey(update: Update, context: CallbackContext):
    if update.callback_query:  # Check if called from a button click
        ...
        if user_id in ADMIN_IDS:
            ...
            await context.bot.send_message(user_id, "ONLY OWNER CAN USE💀OWNER @@LEGEND_ADMIN123")
        ...
        if user_id in ADMIN_IDS:
            ...
            response = "ONLY OWNER CAN USE💀OWNER @@LEGEND_ADMIN123"
...
BOT_TOKEN = '7053691783:AAEv1dIzUAroDeN96kCZgiQOfugB6fA_AeM'
CHANNEL_USERNAME = 'https://t.me/+2h6IjvBZXRg0YmI1'
ADMIN_IDS = ['6486814625']  # Admin user IDs
